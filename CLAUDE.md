...
```bash
cp backlogs/netsuite-rest-metadata/scripts/.env.example backlogs/netsuite-rest-metadata/scripts/.env
```
...
# 接続テスト
python3 backlogs/netsuite-rest-metadata/scripts/export_metadata_from_rest.py --test-auth

# メタデータ取得
python3 backlogs/netsuite-rest-metadata/scripts/export_metadata_from_rest.py --env SB --select salesorder,customer
```
